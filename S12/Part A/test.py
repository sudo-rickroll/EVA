...
def test_model(model, device, test_set, test_loader, regularizer, wrong_preds, correct_labels, wrong_pred_images, last_epoch, class_dict):
  ...
  for batch in test_loader: 
    ...
    test_loss += loss.item() 
    if last_epoch:
      misclassified_images(test_set, pred_values, labels, images, wrong_preds, correct_labels, wrong_pred_images, class_dict)
