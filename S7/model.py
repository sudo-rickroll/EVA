class CustomModel(nn.Module):
    def __init__(self, Dropout):
        ...
        self.layer1 = nn.Sequential(
            ...
            nn.ReLU(),
            nn.BatchNorm2d(32),
            Dropout.dropout(0.1),  # In: 32x32x3 | Out: 32x32x32 | RF: 3x3
        ...
        self.layer2 = nn.Sequential(
            ...
            nn.ReLU(),
            nn.BatchNorm2d(64),
            Dropout.dropout(0.1),  # In: 16x16x32 | Out: 16x16x64 | RF: 10x10
        ...
        self.layer3 = nn.Sequential(
            ...
            nn.ReLU(),
            nn.BatchNorm2d(64),
            Dropout.dropout(0.1),  # In: 8x8x64 | Out: 8x8x64 | RF: 24x24
        ...
        self.layer4 = nn.Sequential(
            ...
            nn.ReLU(),
            nn.BatchNorm2d(128),
            Dropout.dropout(0.1),  # In: 4x4x64 | Out: 2x2x128 | RF: 68x68

            nn.Conv2d(in_channels=128, out_channels=128, kernel_size=(3, 3), padding=1, bias=False),
            nn.ReLU(),
            nn.BatchNorm2d(128),  # In: 2x2x128 | Out: 2x2x128 | RF: 84x84
        )
        self.gap = nn.AvgPool2d(kernel_size=2)  # In: 2x2x128 | Out: 1x1x128 | RF: 108x108
